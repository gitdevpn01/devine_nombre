...
#print("Essaye de deviner le nombre que j'ai choisi entre "  + str(nb_min) + " et " + str(nb_max) + " en " + str(nb_essai)  + " essais.")
...
for i in range(nb_essai):
    ...
    if nb_secret == nb_user:
        print(f"Bravo ! Tu as deviné le nombre {nb_secret} en {i} essai(s).")
        break
